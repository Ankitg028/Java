class employee {
    ...
    public String getdate(int id) {
        return joining_date[getIndex(id)];
    }
    ...
    public static void main(String[] args) {
        if(args.length != 1) {
            ...
            if(emp.empExists(emp_id)) {
                System.out.println("Emp No.    Emp Name    Department    Designation    Salary    Date-of-Joining");
                ...
                System.out.printf("%6d", emp.getSalary(emp_id));
